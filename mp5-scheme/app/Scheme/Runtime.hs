...
evalPrim [] = eval Void
evalPrim [Pair x y] = eval (Pair x y)
evalPrim [x] = eval x
...
isList [Pair _ x] = case flattenList x of Right (x:xs) -> return $ Boolean True 
                                          _ -> return $ Boolean False
isList [list] = case flattenList list of Right [] -> return $ Boolean True 
                                         _ -> return $ Boolean False
...
isPair other = throwError $ UnexpectedArgs other
...
isNumber other = throwError $ UnexpectedArgs other
...
isNull [list] = case flattenList list of Right [] -> return $ Boolean True
                                         _ -> return $ Boolean False
isNull other = throwError $ UnexpectedArgs other
